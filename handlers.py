from server.response import Response, render_template
from server.auth_service import AuthService
from main import app

def home():
    response = Response()
    return render_template(response, app.config["TEMPLATE_DIR"], "home.html")

def about():
    response = Response()
    return render_template(response, "about.html", app.config)
